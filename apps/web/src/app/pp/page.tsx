  ...
  return (
    <Card className="flex min-w-[300px] max-w-2xl flex-col justify-evenly p-8 m-4">
      ...
      <p className="text-muted-foreground mb-4">
        This Privacy Policy explains how git.show ("we", "our", "us") collects,
        uses, and discloses information about you. By using our app, you agree
      ...
      <ul className="list-disc list-inside space-y-3 text-muted-foreground mb-4">
        <li>
          ...
          that you provide to us, such as your email address, name, GitHub ID,
          GitHub username, X ID, and X username.
        </li>
        <li>
          <strong>Authentication Tokens</strong>: We collect authentication
          tokens from GitHub and X to enable the integration with these
          services.
        </li>
        <li>
          <strong>Usage Data</strong>: We collect information on how you access
          and use our app, including your interactions with our app.
        </li>
        <li>
          <strong>Cookies and Tracking Technologies</strong>: We use cookies and
          similar tracking technologies to track activity on our app and store
          certain information. You can manage your cookie preferences through
      ...
      <ul className="list-disc list-inside space-y-3 text-muted-foreground mb-4">
        <li>
          ...
          information to operate, maintain, and provide you with the features of
          our app.
        </li>
        <li>
          <strong>To Communicate with You</strong>: We may use your email to
          send you updates, notifications, and other information about the app.
        </li>
        <li>
          <strong>To Improve Our Service</strong>: We use the data collected to
      ...
      <p className="text-muted-foreground mb-3">
        ...
        identifiable information to outside parties, except as described below:
      </p>
      
      <ul className="list-disc list-inside space-y-3 text-muted-foreground mb-4">
        <li>
          <strong>Third-Party Service Providers</strong>: We may share your
          information with third-party service providers (Github and X) to
          perform functions and provide services to us.
        </li>
        <li>
      ...
      <p className="text-muted-foreground mb-4">
        We use technical measures to protect your personal information. These
        measures include encryption, access controls, and periodic security
        updates. However, no method of transmission over the Internet, or method
      ...
      <p className="text-muted-foreground mb-4">
        Our app is not intended for use by children under the age of 16. We do
        not knowingly collect personally identifiable information from children
        under 16. If you become aware that a child has provided us with personal
        data, please contact us at contact@andreiv.com. If we become aware that
        we have collected personal data from a child under age 16 without
      ...
      <p className="text-muted-foreground mb-4">
        For the purposes of the General Data Protection Regulation (GDPR), the
        Data Controller is git.show and can be contacted at contact@andreiv.com.
      </p>
      
      <h2 className="text-xl font-semibold mt-6 mb-3">2. Lawful Basis for Processing</h2>
      
      <p className="text-muted-foreground mb-4">
        We process your personal data on the lawful basis of your consent and
      ...
      <p className="text-muted-foreground mb-4">
        Users have the ability to delete their data entirely through the
        settings in our app. If you need assistance, please contact us at
        contact@andreiv.com.
      </p>
      ...
      <p className="text-muted-foreground mb-3">
        If we transfer your personal data outside the European Economic Area, we
        will ensure that it is protected in a manner that is consistent with how
        your personal data will be protected by us in the EEA. This can be done
        in a number of ways, for instance:
      </p>
      
      <ul className="list-disc list-inside space-y-3 text-muted-foreground">
        <li>
          the country to which we send the personal data might be approved by
          the European Commission as offering a sufficient level of protection;
        </li>
        <li>
          the recipient might have signed up to a contract based on "model
          contractual clauses" approved by the European Commission, obliging
          them to protect your personal data;
        </li>
        <li>
          where the recipient is located in the US, it might be a certified
          member of the EU-US Privacy Shield scheme; or
        </li>
        <li>
          in other circumstances where the law permits us to otherwise
          transfer your personal data outside the EEA.
        </li>
      </ul>
    </Card>
  );
