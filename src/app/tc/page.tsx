  ...
  return (
    <Card className="flex min-w-[300px] max-w-2xl flex-col justify-evenly p-8 m-4">
      ...
      <p className="text-muted-foreground mb-4">
        These Terms and Conditions ("Terms") govern your use of git.show ("we", "our", "us"). By
      ...
      <ul className="list-disc list-inside space-y-2 text-muted-foreground mb-4">
        ...
        <li>
          <strong>"Content"</strong> refers to any text, images, or other material provided through
          the app.
        </li>
      </ul>
      ...
      <p className="text-muted-foreground mb-4">
        To use our app, you must be at least 16 years old or have parental consent. By using the
        app, you represent and warrant that you meet these eligibility requirements.
      </p>

      <h2 className="text-xl font-semibold mt-6 mb-3">3. Use of the App</h2>
      <p className="text-muted-foreground mb-4">
        You agree to use the app in accordance with these Terms and all applicable laws and
        regulations. You must not use the app for any illegal or unauthorized purpose.
      </p>

      <h2 className="text-xl font-semibold mt-6 mb-3">4. User Accounts</h2>
      <p className="text-muted-foreground mb-4">
        You are responsible for maintaining the confidentiality of your account information,
        including your email, passwords, and authentication tokens. You agree to accept
      ...
      <p className="text-muted-foreground mb-4">
        In no event shall git.show, nor its directors, employees, partners, agents, suppliers, or
      ...
      <p className="text-muted-foreground mb-4">
        These Terms shall be governed and construed in accordance with the laws of Romania, without
      ...
      <p className="text-muted-foreground mb-4">
        ...
        amicable negotiations between the parties. If the dispute cannot be resolved amicably, it
        shall be submitted to the competent courts in Romania.
      </p>

      <h2 className="text-xl font-semibold mt-6 mb-3">9. Severability</h2>
      <p className="text-muted-foreground mb-4">
        If any provision of these Terms is found to be invalid or unenforceable by a court, the
        remaining provisions will remain in effect.
      </p>

      <h2 className="text-xl font-semibold mt-6 mb-3">10. Entire Agreement</h2>
      <p className="text-muted-foreground mb-4">
        These Terms constitute the entire agreement between us regarding our app and supersede and
        replace any prior agreements we might have had between us regarding the app.
      </p>
      ...
      <p className="text-muted-foreground">
        If you have any questions about these Terms, please contact us at contact@andreiv.com.
      </p>
    </Card>
  );
}
