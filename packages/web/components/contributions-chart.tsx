...
export default function ContributionsChartCard({
  name,
  twittertag,
  picture,
  svg,
  ...
  const [url, setUrl] = useState("/contributions-chart.svg");
  ...
  return (
    ...
    >
      <div className="absolute">
        ...
        <div className="bg-[#22272E] rounded-t-lg w-[500px] h-[10.25em]" />
        <div className="bg-black rounded-b-lg w-[500px] h-[6em]" />

        <picture>
          <img
            className={`absolute w-auto h-auto rounded-t-lg left-1/2 transform -translate-x-1/2 bottom-[6em]`}
            src={url}
            width={500}
            height={250}
